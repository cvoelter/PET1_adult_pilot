...
# Read raw text
raw_txt <- readLines("data/sam2_aoi/solidity_ver2_n_cont_sam2.json")
...
# Read raw text
raw_txt <- readLines("data/sam2_aoi/solidity_ver2_n_test_sam2.json")
# Replace NaN with null
raw_txt <- gsub(": NaN", ": null", raw_txt)
# Parse
...
ggsave(
  gaze_x_plot,
  filename = "graphs/solidity2/solidity__ver2_x-gaze.png",
  height = 5,
  width = 10,
  scale = 0.8
)
