...
full.data  <- full.data  %>%
  rename(
    ...
    # 'AOI.hit..solidity_ver2_n_cont...Rectangle.2.',  # this is the rectangle in the back
    # 'AOI.hit..solidity_ver2_n_test...Rectangle.1.',  # this is the rectangle in the back
    ...
    'AOI.hit.continuity.ver1.cont.supr.event.left' = 'AOI.hit..continuity_ver1_n_cont...Rectangle.2.',
    'AOI.hit.continuity.ver1.cont.supr.event.right' = 'AOI.hit..continuity_ver1_n_cont...Rectangle.1.',
    'AOI.hit.continuity.ver1.test.supr.event.left' = 'AOI.hit..continuity_ver1_n_test...Rectangle.',
    'AOI.hit.continuity.ver1.test.supr.event.right' = 'AOI.hit..continuity_ver1_n_test...Rectangle.1.',
