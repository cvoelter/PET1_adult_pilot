...
todo: create a table with the proportion on screen samples for three interest periods: start_event + 4000, relevant events (IP1-IP3) , and the bseline phase (start_event - 3000?)

create a plot with the cumulative proportion of apes looking onscreen in 100msec bins of video time on x-axis
...
# baseline.end<-3000
# start_ip <- 3000
video.data <- read_csv("data/PET_adult_pilot_video_list_frame_by_frame_matched_29-97fps.csv")%>%
...
eye_data <- read_tsv("data/PET_network_study1_Ngamba_20_November.tsv",
                     na = c("", "NA", "N/A")) %>%
...
eye_data <- eye_data %>%
  ...
  rename(
    ...
    'AOI_hit_gravity_ver1_cont_apple'  = 'AOI_hit_[gravity_ver1_n_cont_-_apple]',
    'AOI_hit_gravity_ver1_test_apple' = 'AOI_hit_[gravity_ver1_n_test_-_apple]',

    'AOI_hit_gravity_ver1_cont_whole_screen'  = 'AOI_hit_[gravity_ver1_n_cont_-_whole_screen]',
    'AOI_hit_gravity_ver1_test_whole_screen' = 'AOI_hit_[gravity_ver1_n_test_-_whole_screen]',

    'AOI_hit_gravity_ver1_cont_space_under_apple'  = 'AOI_hit_[gravity_ver1_n_cont_-_space_under_apple]',
    'AOI_hit_gravity_ver1_test_space_under_apple' = 'AOI_hit_[gravity_ver1_n_test_-_space_under_apple]',

    #Gravity Ver 2

    'AOI_hit_gravity_ver2_cont_apple' = 'AOI_hit_[gravity_ver2_n_cont_-_apple]',
    'AOI_hit_gravity_ver2_test_apple' = 'AOI_hit_[gravity_ver2_n_test_-_apple]',

    'AOI_hit_gravity_ver2_cont_whole_screen' = 'AOI_hit_[gravity_ver2_n_cont_-_whole_screen]',
    'AOI_hit_gravity_ver2_test_whole_screen' = 'AOI_hit_[gravity_ver2_n_test_-_whole_screen]',

    'AOI_hit_gravity_ver2_cont_space_under_apple' = 'AOI_hit_[gravity_ver2_n_cont_-_space_under_apple]',
    'AOI_hit_gravity_ver2_test_space_under_apple' = 'AOI_hit_[gravity_ver2_n_test_-_space_under_apple]',

    #Solidity Ver 1

    'AOI_hit_solidity_ver1_cont_apple'  = 'AOI_hit_[solidity_ver1_n_cont_-_apple]',
    'AOI_hit_solidity_ver1_test_apple'  = 'AOI_hit_[solidity_ver1_n_test_-_apple]',

    'AOI_hit_solidity_ver1_cont_barrier'  = 'AOI_hit_[solidity_ver1_n_cont_-_barrier]',
    'AOI_hit_solidity_ver1_test_barrier'  = 'AOI_hit_[solidity_ver1_n_test_-_barrier]',

    'AOI_hit_solidity_ver1_cont_whole_screen'  = 'AOI_hit_[solidity_ver1_n_cont_-_whole_screen]',
    'AOI_hit_solidity_ver1_test_whole_screen'  = 'AOI_hit_[solidity_ver1_n_test_-_whole_screen]',

    #Solidity Ver 2

    'AOI_hit_solidity_ver2_cont_apple' = 'AOI_hit_[solidity_ver2_n_cont_-_apple]',
    'AOI_hit_solidity_ver2_test_apple' = 'AOI_hit_[solidity_ver2_n_test_-_apple]',

    'AOI_hit_solidity_ver2_cont_barrier_left' = 'AOI_hit_[solidity_ver2_n_cont_-_barrier_left]',
    'AOI_hit_solidity_ver2_test_barrier_left' = 'AOI_hit_[solidity_ver2_n_test_-_barrier_left]',

     'AOI_hit_solidity_ver2_cont_barrier_right' = 'AOI_hit_[solidity_ver2_n_cont_-_barrier_right]',
     'AOI_hit_solidity_ver2_test_barrier_right' = 'AOI_hit_[solidity_ver2_n_test_-_barrier_right]',

    'AOI_hit_solidity_ver2_cont_whole_screen' = 'AOI_hit_[solidity_ver2_n_cont_-_whole_screen]',
    'AOI_hit_solidity_ver2_test_whole_screen' = 'AOI_hit_[solidity_ver2_n_test_-_whole_screen]',
    

    #Continuity Ver 1

    'AOI_hit_continuity_ver1_cont_apple' = 'AOI_hit_[continuity_ver1_n_cont_-_apple]',
    'AOI_hit_continuity_ver1_test_apple' = 'AOI_hit_[continuity_ver1_n_test_-_apple]',
    ...
    'AOI_hit_continuity_ver1_cont_barrier_right' = 'AOI_hit_[continuity_ver1_n_cont_-_barrier_right]',
    'AOI_hit_continuity_ver1_cont_barrier_right' = 'AOI_hit_[continuity_ver1_n_cont_-_barrier_right]',
    'AOI_hit_continuity_ver1_test_barrier_left' = 'AOI_hit_[continuity_ver1_n_test_-_barrier_left]',
    'AOI_hit_continuity_ver1_test_barrier_left' = 'AOI_hit_[continuity_ver1_n_test_-_barrier_left]',

    'AOI_hit_continuity_ver1_cont_whole_screen'  = 'AOI_hit_[continuity_ver1_n_cont_-_whole_screen]',
    'AOI_hit_continuity_ver1_test_whole_screen' = 'AOI_hit_[continuity_ver1_n_test_-_whole_screen]',
    
    #Continuity Ver 2

    'AOI_hit_continuity_ver2_cont_apple' = 'AOI_hit_[continuity_ver2_n_cont_-_apple]',
    'AOI_hit_continuity_ver2_test_apple' = 'AOI_hit_[continuity_ver2_n_test_-_apple]',

    'AOI_hit_continuity_ver2_cont_gap_between_barriers' = 'AOI_hit_[continuity_ver2_n_cont_-_gap_between_barriers]',
    'AOI_hit_continuity_ver2_test_gap_between_barriers' = 'AOI_hit_[continuity_ver2_n_test_-_gap_between_barriers]',

    'AOI_hit_continuity_ver2_cont_whole_screen' = 'AOI_hit_[continuity_ver2_n_cont_-_whole_screen]',
    'AOI_hit_continuity_ver2_test_whole_screen' = 'AOI_hit_[continuity_ver2_n_test_-_whole_screen]',
...
gaze_ip <- sample_data %>%
  ...
  arrange(subject, video_file, RECORDING_SESSION_LABEL, time_frame) %>%
  group_by(subject, video_file, RECORDING_SESSION_LABEL) %>%
  mutate(
    dt = lead(time_frame) - time_frame
  ) %>%
  ungroup()
...
ip_summary <- gaze_ip %>%
  ...
  summarise(
    onscreen_time = sum(dt[onscreen], na.rm = TRUE),
...
ip_summary <- ip_summary %>%
  mutate(
    prop_IP1_of_IP =
      IP1_gaze_time / IP1_duration,

    prop_IP2_of_IP =
      IP2_gaze_time / IP2_duration,

    prop_IP3_of_IP =
      IP3_gaze_time / IP3_duration
  )
```
...
aoi_suffixes <- c("whole_screen", "apple", "space_under_apple",  "supr_event_left",  "supr_event_right")
